...
# corporation_index_second_stage_file_url = u'data/processed_data/corporation_index/second_stage/'  # corporation index files in the second stage
...
origin_file_url = u'data/test/赛题1数据材料/赛题1测试数据集/赛题1测试数据集/'  # the original file folder url, files in it should be read only
working_file_url = u'data/test/processed_data/raw_data/'  # the working file folder, a copy from the original file folder, can be changed during work
statistic_data_file_url = u'data/test/processed_data/statistic_data/'  # statistic info for every table
categorized_data_file_url = u'data/test/processed_data/categorized_data/'  # categorized info for every table
cleaned_data_file_url = u'data/test/processed_data/cleaned_data/'  # cleaned tables
clean_data_temp_file_url = u'data/test/processed_data/clean_data_temp/'  # clean temp tables
corporation_index_file_url = u'data/test/processed_data/corporation_index/'  # corporation index files
corporation_index_second_stage_file_url = u'data/test/processed_data/corporation_index/second_stage/'  # corporation index files in the second stage
