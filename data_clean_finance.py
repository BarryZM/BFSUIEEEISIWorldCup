...
from file_directions import clean_data_temp_file_url, corporate_index_false
import file_utils
import pandas
...
def data_clean_finance_mgzb():
    ...
    dcu.merge_rows_by_columns(u'上市公司财务信息-每股指标', keys=[corporate_index_false, u'日期'])
...
def data_clean_finance_cwfxzb():
    ...
    dcu.merge_status(u'上市信息财务信息-财务风险指标', u'资产负债率(%)'.encode('utf-8'), status_list, status_after, empty_mask='Unknown')
    dcu.merge_status(u'上市信息财务信息-财务风险指标', u'流动负债/总负债(%)'.encode('utf-8'), status_list, status_after, empty_mask='Unknown')
    dcu.merge_status(u'上市信息财务信息-财务风险指标', u'流动比率'.encode('utf-8'), status_list, status_after, empty_mask='Unknown')
    dcu.merge_status(u'上市信息财务信息-财务风险指标', u'速动比率'.encode('utf-8'), status_list, status_after, empty_mask='Unknown')
...
def data_clean_finance_cznlzb():
    ...
    """
    # dcu.drop_columns(u'上市信息财务信息-成长能力指标', u'标题'.encode('utf-8'))
    # dcu.adjust_time(u'上市信息财务信息-成长能力指标', u'日期'.encode('utf-8'))
    #
    # status_normal = [u'--', u'--%']  # 搜索满足这个条件的
    # status_list = [status_normal]
    # status_after = ['Unknown']  # 改成这个
    #
    # dcu.merge_status(u'上市信息财务信息-成长能力指标', u'营业总收入(元)'.encode('utf-8'), status_list, status_after, empty_mask='Unknown')
    # dcu.merge_status(u'上市信息财务信息-成长能力指标', u'毛利润(元)'.encode('utf-8'), status_list, status_after, empty_mask='Unknown')
    # dcu.merge_status(u'上市信息财务信息-成长能力指标', u'归属净利润(元)'.encode('utf-8'), status_list, status_after, empty_mask='Unknown')
    # dcu.merge_status(u'上市信息财务信息-成长能力指标', u'扣非净利润(元)'.encode('utf-8'), status_list, status_after, empty_mask='Unknown')
    # dcu.merge_status(u'上市信息财务信息-成长能力指标', u'营业总收入同比增长(元)'.encode('utf-8'), status_list, status_after, empty_mask='Unknown')
    # dcu.merge_status(u'上市信息财务信息-成长能力指标', u'归属净利润同比增长(元)'.encode('utf-8'), status_list, status_after, empty_mask='Unknown')
    # dcu.merge_status(u'上市信息财务信息-成长能力指标', u'扣非净利润同比增长(元)'.encode('utf-8'), status_list, status_after, empty_mask='Unknown')
    # dcu.merge_status(u'上市信息财务信息-成长能力指标', u'营业总收入滚动环比增长(元)'.encode('utf-8'), status_list, status_after, empty_mask='Unknown')
    # dcu.merge_status(u'上市信息财务信息-成长能力指标', u'归属净利润滚动环比增长(元)'.encode('utf-8'), status_list, status_after, empty_mask='Unknown')
    # dcu.merge_status(u'上市信息财务信息-成长能力指标', u'扣非净利润滚动环比增长(元)'.encode('utf-8'), status_list, status_after, empty_mask='Unknown')
    # dcu.change_number(u'上市信息财务信息-成长能力指标', u'营业总收入(元)'.encode('utf-8'))
    dcu.change_number(u'上市信息财务信息-成长能力指标', u'毛利润(元)'.encode('utf-8'))
    dcu.change_number(u'上市信息财务信息-成长能力指标', u'归属净利润(元)'.encode('utf-8'))
    dcu.change_number(u'上市信息财务信息-成长能力指标', u'扣非净利润(元)'.encode('utf-8'))

    unit_strs = [u'%']
    dcu.drop_unit(u'上市信息财务信息-成长能力指标', u'营业总收入同比增长(元)'.encode('utf-8'), unit_strs)
...
def data_clean_finance_ylnlzb():
    ...
    dcu.mark_invalid_num_data(u'上市信息财务信息盈利能力指标', u'毛利率(%)'.encode('utf-8'), '>', 100, error_mask='-65535')
    dcu.mark_invalid_num_data(u'上市信息财务信息盈利能力指标', u'净利率(%)'.encode('utf-8'), '>', 100, error_mask='-65535')
    dcu.mark_invalid_num_data(u'上市信息财务信息盈利能力指标', u'实际税率(%)'.encode('utf-8'), '>', 100, error_mask='-65535')
...
def data_clean_finance_yynlzb():
    ...
    dcu.merge_status(u'上市信息财务信息运营能力指标', u'总资产周转率(次)'.encode('utf-8'), status_list, status_after, empty_mask='-65535')
    dcu.merge_status(u'上市信息财务信息运营能力指标', u'应收账款周转天数(天)'.encode('utf-8'), status_list, status_after)
    dcu.merge_status(u'上市信息财务信息运营能力指标', u'存货周转天数(天)'.encode('utf-8'), status_list, status_after)

    dcu.mark_invalid_num_data(u'上市信息财务信息运营能力指标', u'应收账款周转天数(天)'.encode('utf-8'), '<', 0, error_mask=-65535)
    dcu.mark_invalid_num_data(u'上市信息财务信息运营能力指标', u'存货周转天数(天)'.encode('utf-8'), '<', 0, error_mask=-65535)
...
def work_():
    duplicate_handle()
    data_clean_finance_cwfxzb()
    data_clean_finance_cznlzb()
    data_clean_finance_ylnlzb()
    data_clean_finance_yynlzb()
    empty_value_handle_basic_info()
